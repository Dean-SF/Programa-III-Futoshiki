...
class Panel(tk.Frame):
    def __init__(self,master,panel_digitos):
        ...
        # tercer fila
        self.boton11 = tk.Button(self,text="1",font=font,width=3,height=1,command=lambda:self.cambioNumero(self.boton11))
        self.boton11.grid(row=4,column=0)
        tk.Label(self,text="",font=mayor_menor_font,width=2).grid(row=4,column=1)
        self.boton12 = tk.Button(self,text="1",font=font,width=3,height=1,command=lambda:self.cambioNumero(self.boton12))
        self.boton12.grid(row=4,column=2)
        tk.Label(self,text="",font=mayor_menor_font,width=2).grid(row=4,column=3)
        self.boton13 = tk.Button(self,text="1",font=font,width=3,height=1,command=lambda:self.cambioNumero(self.boton13))
        ...
        self.boton15 = tk.Button(self,text="1",font=font,width=3,height=1,command=lambda:self.cambioNumero(self.boton15))
        ...
        # Cuarta fila
        self.boton16 = tk.Button(self,text="1",font=font,width=3,height=1,command=lambda:self.cambioNumero(self.boton16))
        self.boton16.grid(row=6,column=0)
        tk.Label(self,text="",font=mayor_menor_font,width=2).grid(row=6,column=1)
        self.boton17 = tk.Button(self,text="1",font=font,width=3,height=1,command=lambda:self.cambioNumero(self.boton17))
        self.boton17.grid(row=6,column=2)
        tk.Label(self,text="",font=mayor_menor_font,width=2).grid(row=6,column=3)
        self.boton18 = tk.Button(self,text="1",font=font,width=3,height=1,command=lambda:self.cambioNumero(self.boton18))
        self.boton18.grid(row=6,column=4)
        tk.Label(self,text="",font=mayor_menor_font,width=2).grid(row=6,column=5)
        self.boton19 = tk.Button(self,text="1",font=font,width=3,height=1,command=lambda:self.cambioNumero(self.boton19))
        self.boton19.grid(row=6,column=6)
        tk.Label(self,text="",font=mayor_menor_font,width=2).grid(row=6,column=7)
        self.boton20 = tk.Button(self,text="1",font=font,width=3,height=1,command=lambda:self.cambioNumero(self.boton20))
        ...
        # Quinta fila
        self.boton21 = tk.Button(self,text="1",font=font,width=3,height=1,command=lambda:self.cambioNumero(self.boton21))
        self.boton21.grid(row=8,column=0)
        tk.Label(self,text="",font=mayor_menor_font,width=2).grid(row=8,column=1)
        self.boton22 = tk.Button(self,text="1",font=font,width=3,height=1,command=lambda:self.cambioNumero(self.boton22))
        self.boton22.grid(row=8,column=2)
        tk.Label(self,text="",font=mayor_menor_font,width=2).grid(row=8,column=3)
        self.boton23 = tk.Button(self,text="1",font=font,width=3,height=1,command=lambda:self.cambioNumero(self.boton23))
        self.boton23.grid(row=8,column=4)
        tk.Label(self,text="",font=mayor_menor_font,width=2).grid(row=8,column=5)
        self.boton24 = tk.Button(self,text="1",font=font,width=3,height=1,command=lambda:self.cambioNumero(self.boton24))
        self.boton24.grid(row=8,column=6)
        tk.Label(self,text="",font=mayor_menor_font,width=2).grid(row=8,column=7)
        self.boton25 = tk.Button(self,text="1",font=font,width=3,height=1,command=lambda:self.cambioNumero(self.boton25))
